...
class HomeController extends Controller
{
    ...
    // $mail->AltBody = 'This is the body in plain text for non-HTML mail clients';
        ...
        $body .= '<b> Paul </b> <img src="http://cryptic-wave-76259.herokuapp.com/blank/'.$track_code.'" width="1" height="1" border="0" alt=""/><a href="https://cryptic-wave-76259.herokuapp.com/>heroku</a>"';
        $mail->Body = $body;
